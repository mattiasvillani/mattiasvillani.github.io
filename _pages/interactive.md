...
- [Bayesian inference for normal data with known variance](https://observablehq.com/@mattiasvillani/bayes-iid-gaussian-known-var)
- [Bayesian inference for normal data with unknown variance](https://observablehq.com/@mattiasvillani/bayesian-inference-for-gaussian-iid-data)
- [Bayesian inference for counts](https://observablehq.com/@mattiasvillani/bayesian-inference-for-iid-poisson-counts)
- [Bayesian inference for exponential data](https://observablehq.com/@mattiasvillani/bayesian-inference-for-exponential-iid-data)
- [Bayesian inference for multinomial data](https://observablehq.com/@mattiasvillani/multinomial-dirichlet)
- [Bayesian credible intervals](https://observablehq.com/@mattiasvillani/bayesian-credible-intervals)
- [Prior predictive distribution for Poisson model](https://observablehq.com/@mattiasvillani/prior_pred_poismodel)
